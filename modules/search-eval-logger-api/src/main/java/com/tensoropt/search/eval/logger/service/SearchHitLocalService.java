...
/**
 * Provides the local service interface for SearchHit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SearchHitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SearchHitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.tensoropt.search.eval.logger.service.impl.SearchHitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the search hit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SearchHitLocalServiceUtil} if injection and service tracking are not available.
	 */
