...
public interface SearchHitLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ai.tensoropt.sel.service.impl.SearchHitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the search hit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SearchHitLocalServiceUtil} if injection and service tracking are not available.
	 */
