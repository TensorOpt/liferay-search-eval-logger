...
import com.tensoropt.search.eval.logger.service.base.SearchHitLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.tensoropt.search.eval.logger.model.SearchHit",
